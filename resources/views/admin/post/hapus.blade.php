...
@section('title', 'Post')
@section('sub-judul', 'Pos softdeletes')
@section('content')
    <div class="">
        @if (session('status'))
        ...
        <table class="table table-hover ">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <img src="{{ asset( $hasil->gambar ) }}" class="card-img"  style="width: 5rem;">
                    </td>
                    <td>
                        <a href="" class="badge badge-info">Detail</a>
                    <form method="post" action="{{ route('post.kill', $hasil->id) }}" class="d-inline">
                            @csrf
                            @method('delete')
                            <a href="{{ route('post.restore', $hasil->id) }}" class="badge badge-success">restore</a>
